...
export function ConditionalRenderingDialog() {
    ...
    let defaultRendering = `(currentCreature:Creature) => {
    return true;
}`
    ...
    return <Dialog>
        <DialogTrigger className="m-4"><Button className={"flex flex-row gap-2"}><Split /> Conditional Rendering</Button></DialogTrigger>
